...
Hbase - 0.98.0-hadoop2+, 0.98.1-hadoop2+, 0.98.2-hadoop2+,
        ...
        1.1.8+, 1.1.9+, 1.2.0+, 1.2.1+, 1.2.2+, 1.2.3+, 1.2.4+, 1.3.0+

Pig - 0.13.0, 0.14.0, 0.15.0, 0.16.0

Zookeeper - 3.4.0, 3.4.1, 3.4.2, 3.4.3, 3.4.4, 3.4.5, 3.4.6, 3.4.7,
            3.4.8, 3.4.9

Storm - 0.9.3, 0.9.4, 0.9.5, 0.9.6, 0.10.0, 0.10.1, 0.10.2, 1.0.0,
        1.0.1, 1.0.2, 1.0.3
...
Zeppelin - 0.6.0, 0.6.1, 0.6.2, 0.7.0, 0.7.1
